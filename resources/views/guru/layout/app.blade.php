...
<body class="fixed">
    ...
    <div class="bg-dark fixed hidden h-screen md:inline-block md:w-56">
        ...
        <a href="{{ route('DashboardGuru') }}"
            class="nav-link {{ $webtitle == 'Dashboard' ? 'active bg-yellow-400' : 'btn btn-outline-yellow-400' }} mx-auto mb-2 flex h-12 w-52 items-center rounded-lg text-white hover:bg-yellow-400">
            <div><i class="fa-solid fa-gauge-high mx-3 mr-2 w-5 text-white"></i></div>
            <p class="text-base font-semibold">Dashboard</p>
        </a>
        <a href="{{ url('guru/file') }}"
            class="nav-link {{ $webtitle == 'ReDAKSI | File Arsip' ? 'active bg-yellow-400' : 'btn btn-outline-yellow-400' }} mx-auto mb-2 flex h-12 w-52 items-center rounded-lg text-white hover:bg-yellow-400">
            <div><i class="fa-solid fa-box-archive mx-3 mr-2 w-5 text-white"></i></div>
            <p class="text-base font-semibold">Arsip File</p>
        </a>
    </div>
    </div>
